!function (e) {
    ...
    return e.extend(!0, n.defaults, {
    ...
    }), n.ext.renderer.pageButton.bootstrap = function (a, o, r, d, i, l) {
        var c, u, p, f = new n.Api(a), m = a.oClasses, b = a.oLanguage.oPaginate, g = a.oLanguage.oAria.paginate || {},
            x = 0, w = function (t, s) {
                var n, o, d, p, h = function (a) {
                    a.preventDefault(), e(a.currentTarget).hasClass("disabled") || f.page() == a.data.action || f.page(a.data.action).draw("page")
                };
                for (n = 0, o = s.length; n < o; n++) if (p = s[n], e.isArray(p)) w(t, p); else {
                    switch (c = "", u = "", p) {
                        case"ellipsis":
                            c = "&#x2026;", u = "disabled";
                            break;
                        case"first":
                            c = b.sFirst, u = p + (i > 0 ? "" : " disabled");
                            break;
                        case"previous":
                            c = b.sPrevious, u = p + (i > 0 ? "" : " disabled");
                            break;
                        case"next":
        ...
        w(e(o).empty().html('<ul class="pagination"/>').children("ul"), d), p !== s && e(o).find("[data-dt-idx=" + p + "]").focus()
    }, n
});