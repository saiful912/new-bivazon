                            ...
                            <div class="card-body pb-0">
                                ...
                                <table class="table table-bordered table-hover" id="table_id">
                                    ...
                                    @foreach($payments as $payment)
                                        @if(optional($payment->order)->type == 'wholesale')
                                            <tr>
                                                        ...
                                                        <div class="modal-dialog" role="document">
                                                            <div class="modal-content">
                                                                ...
                                                                <div class="modal-body">
                                                                    <form action="{{route('wholesale.edit_payment',$payment->id)}}" method="post"
                                                    ...
                                                    <div class="modal fade" id="deleteModal-{{$payment->id}}" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                                                        <div class="modal-dialog" role="document">
                                                            <div class="modal-content">
                                                                ...
                                                                <div class="modal-body">
                                                                    <form action="{{route('wholesale.delete_payment',$payment->id)}}" method="post">
                                                                        {{csrf_field()}}
