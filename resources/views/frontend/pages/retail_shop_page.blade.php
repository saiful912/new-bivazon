...
@section('main')
    ...
    <section class="gallery-block cards-gallery">
        <h2 style="text-align: center;margin-bottom: 20px">{{$category->name}} Retail Sale Shop</h2>

        <div class="container-fluid">
            <div class="row">
                @foreach($category->merchants as $merchant)
                    @if($merchant->shop_type=='retail')
                        <div class="col-md-6 col-lg-4">
                            <div class="card border-0 transform-on-hover">
                                <div class="card-body">
                                    <h6>
                                        <a href="{{route('subcategories_retail',['id'=>$category->id,'shop_id'=>$merchant->id])}}" style="padding-top: 5px;
padding-bottom: 5px;display: block">
                                ...
                                <a class="lightbox" href="{{route('subcategories_retail',['id'=>$category->id,'shop_id'=>$merchant->id])}}">
